...
class BankApp:
    ...
    def login_screen(self):
        ...
        card.place(relx=0.5, rely=0.5, anchor=CENTER, width=350, height=220)
    ...
    def login(self):
        ...
        if conta1.check_password(pwd):
            self.current_account = conta1
            self.home_screen()
        elif conta2.check_password(pwd):
            self.current_account = conta2
            self.home_screen()
        else:
    ...
    def extrato_screen(self):
        ...
        for t in self.current_account.extrato():
            Label(card, text=t, anchor='w', bg=CARD_COLOR, font=("Helvetica", 10)).pack(fill='x')
        self.create_menu_button(card, "Voltar", self.home_screen)
    ...
    def change_limit(self):
        try:
            ...
            self.current_account.change_limit(novo)
